        ...
        <div class="row">
            <div class="nav-align-top">
                <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-md-0 gap-2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('staff.certificates.index',$booking->id) }}"><i class="icon-base bx bx-link-alt icon-sm me-1_5"></i>Certificates</a>
                    </li>
                </ul>
            </div>
...
@foreach($doc->bookings as $uploadedDoc)
                                        <a href="{{ route('staff.document.download', $uploadedDoc->id) }}" class="btn btn-primary btn-sm"> <i class="icon-base bx bx-download icon-sm me-2"></i> Download</a>
@endforeach
                ...
                <div class="card mb-6">
                    <div class="card-body">
                        <h5 class="card-action-title mb-0"><i class="icon-base bx bx-bar-chart-alt-2 icon-lg text-body me-4"></i>Payment History
                            ...
                            <a href="{{ route('staff.service_order.add_payment_form',$booking->id) }}" class="btn btn-primary btn-sm float-end"> <i class="icon-base bx bx-user-check icon-sm me-2"></i>Add Payment</a>
                            @else
                            <a href="{{ route('staff.final_invoice.service.download',$booking->id) }}" class="btn btn-primary btn-sm float-end"> <i class="icon-base bx bx-download icon-sm me-2"></i>Download Final Invoice</a>
                            @endif
                        </h5>
                        <hr />
                ...
                <div class="card card-action mb-1">
                    <div class="card-header align-items-center">
                        <h5 class="card-action-title mb-0"><i class="icon-base bx bx-bar-chart-alt-2 icon-lg text-body me-4"></i>Service Fees Details Order #{{ $booking->id }} ({{ $booking->service->name }})
                            @if($booking->total_amount==0)<a href="{{ route('staff.service_order.add_fees_form', $booking->id) }}" class="btn btn-primary btn-sm float-end"> <i class="icon-base bx bx-user-check icon-sm me-2"></i> Add Amount </a>@endif
                        </h5>
                    </div>
                    <div class="card-body">
    ...
    <div class="content-backdrop fade"></div>
      ...
      <!-- Large Modal -->
        <div class="modal fade" id="largeModal" tabindex="-1" aria-hidden="true">
            <form action="{{ route('staff.service_order.update_status', $booking->id) }}" method="POST">
                    @csrf
