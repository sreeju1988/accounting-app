        ...
        <div class="row">
                ...
                <div class="nav-align-top">
                    <ul class="nav nav-pills flex-column flex-md-row mb-6 gap-md-0 gap-2">
                      <li class="nav-item">
                        <a class="nav-link " href="{{ route('admin.service_order.show', $booking->id) }}"><i class="icon-base bx bx-user icon-sm me-1_5"></i> Service Order</a>
                      </li>
            ...
            <div class="col-md-12">
                ...
                <div class="card mb-6">
                  <h4 class="card-header">Certificates List
                    <a href="{{ route('admin.certificates.create',$booking->id) }}" class="btn btn-primary float-end">Add Certificate</a>
                  </h4>
                    @if(session('success'))
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.certificates.download', $certificate->id) }}" class="btn btn-sm btn-primary">Download</a>
