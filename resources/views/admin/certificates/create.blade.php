    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card mb-6">
          ...
          <div class="card-body">
            <form id="formAccountSettings" method="POST" action="{{ route('admin.certificates.store', $serviceOrder->id) }}" enctype="multipart/form-data">
              @csrf
              <div class="row g-6">
                ...
                <div class="mt-6">
                  ...
                  <a href="{{ route('admin.certificates.index', $serviceOrder->id) }}" class="btn btn-outline-secondary">Back to Certificates</a>
                </div>
