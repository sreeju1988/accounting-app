            ...
            <div class="authentication-inner">
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-1">Complete Registration (Agent) 🔒</h4>
                        <p class="mb-6">Complete your registration by filling in the details below:</p>

                        <form id="formAuthentication" class="mb-6" action="{{ route('invitations.agent.register', $invitation->token) }}" method="POST">
                            @csrf
                            <div class="mb-6">
