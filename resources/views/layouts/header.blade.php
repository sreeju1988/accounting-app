...
<head>
    ...
    <title>PracticePro - Powerful SaaS Accounting & Business Management</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ url('public/theme/assets/img/favicon/favicon.ico') }}" />
    ...
    <link rel="stylesheet" href="{{ url('public/theme/assets/vendor/libs/apex-charts/apex-charts.css')}}" />
