...
class ServicePaymentController extends Controller
{
     public function addPaymentForm($bookingId)
    {
        ...
        return view('staff.payments.add_payment', compact('booking'));
    }
    ...
    public function storePayment(Request $request, $bookingId)
    {
        ...
        return redirect()->route('staff.service_order.show', $booking->id)
    ...
    // Staff view of payments for a specific order
    public function staffIndex($orderId)
    {
        $booking = ServiceBooking::with('payments')->findOrFail($orderId);
        return view('staff.payments.index', compact('booking'));
    }
}
